...
class SettingsComponent {
  ...
  ngOnInit() {
    if (this.acceptedCookies()) {
      this.store.dispatch(_models_app_model__WEBPACK_IMPORTED_MODULE_0__.AppActions.hideFooter());
    }
  ...
  ngOnDestroy() {
    ...
    this.store.dispatch(_models_app_model__WEBPACK_IMPORTED_MODULE_0__.AppActions.showFooter());
    this.onDestroy$.next();
  }
  saveSettings() {
