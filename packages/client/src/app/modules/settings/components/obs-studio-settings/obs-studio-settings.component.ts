...
@Component({
  selector: 'app-obs-studio-settings',
  templateUrl: './obs-studio-settings.component.html',
  styleUrls: ['./obs-studio-settings.component.scss'],
})
export class ObsStudioSettingsComponent {
