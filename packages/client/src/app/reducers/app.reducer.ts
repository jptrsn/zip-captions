...
export const appAppearanceReducers = createReducer(
  ...
  on(AppActions.checkUserAgentComplete, (state: AppAppearanceState, action: {error?: string, warning?: string}) => ({...state, loading: false, error: action.error, warning: action.warning})),
