...
export const audioStreamReducers = createReducer(defaultAudioStreamState, 
  ...
  on(AudioStreamActions.disconnectStreamSuccess, (state: AudioStreamState, action: { id: string}) => ({...state, id: action.id, state: AudioStreamStatus.disconnected, error: undefined})),
