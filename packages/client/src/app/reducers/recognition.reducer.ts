...
export const recognitionReducers = createReducer(defaultRecognitionState,
  ...
  on(RecognitionActions.pause, (state: RecognitionState) => ({...state, status: RecognitionStatus.paused})),
  on(RecognitionActions.resume, (state: RecognitionState) => ({...state, status: RecognitionStatus.connected})),
  on(RecognitionActions.error, (state: RecognitionState, action:{ error: string}) => ({...state, error: action.error, status: RecognitionStatus.error })),
