...
declare const SpeechGrammarList: { prototype: SpeechGrammarList; new (): SpeechGrammarList };
...
declare const webkitSpeechGrammarList: { prototype: SpeechGrammarList; new (): SpeechGrammarList; };
